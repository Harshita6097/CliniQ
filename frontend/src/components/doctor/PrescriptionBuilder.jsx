    ...
    <div>
      <div className="flex items-center justify-between mb-3">
        ...
        <button
          type="button"
          onClick={addItem}
          className="flex items-center gap-1.5 text-xs font-semibold text-doctor bg-doctor-tint hover:bg-doctor-tint2 px-3 py-1.5 rounded-md transition-colors"
        >
        ...
        {prescription.map((item, i) => (
          <div key={i} className="border border-doctor/20 rounded-md p-4 bg-doctor-tint/30 space-y-3">
            <div className="flex items-center justify-between">
              <span className="font-mono text-[11px] font-bold text-doctor bg-doctor-tint px-2.5 py-0.5 rounded-full">
                Medicine {i + 1}
              </span>
              <button
                type="button"
