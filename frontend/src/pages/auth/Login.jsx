            ...
            {features.map(({ label, sub }) => (
              <li key={label} className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-patient-tint text-xs mt-0.5">{sub}</p>
                </div>
              </li>
            ))}
          </ul>
      ...
      <div className="flex-1 flex items-center justify-center bg-paper px-6 py-12">
        <div className="w-full max-w-md animate-fadeIn">
          ...
          <div className="bg-white rounded-lg border border-stone shadow-soft p-8">
            ...
            <div className="mt-6 pt-6 border-t border-stone text-center">
              <p className="text-sm text-ink-soft">
                ...
                <Link to="/register" className="text-patient hover:text-patient-dark font-semibold hover:underline">Create one</Link>
              </p>
            </div>
          </div>
          ...
          <div className="mt-4 flex items-start gap-2 bg-patient-tint border border-patient/20 rounded-md px-4 py-3">
            ...
            <p className="text-xs text-patient-dark">Doctors &amp; admins — use credentials provided by your administrator.</p>
          </div>
        </div>
      </div>
    </div>
